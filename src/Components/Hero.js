            ...
            <div className="h-[90%] w-full flex flex-col justify-evenly  ">
              <div className=" heroText mt-6  h-1/2 flex flex-col items-center justify-evenly">
                <h1 className="text-3xl font-bold ">
                  Moderniing Mobile Platforms
                </h1>
                <p className="font-normal text-base leading-relaxed self-center text-center  text-[rgba(255,255,255,.9)] w-full ">
                  Custom mobile apps.User experiences & design.Engagement &
                  Intelligence.Native & cross-platforms
                </p>
                <div className="bg-primary px-4 py-1 rounded-sm w-40 h-10 text-center flex justify-center items-center">
