...
export default function Navbar() {
  return (
    <>
    <div className='container1 navbar h-[10vh] w-screen border border-purple-700 xsm:bg-white absolute '>
        <div className="navleft  ">
            <div className="logo w-[97px]">
                <img src="https://www.cubix.co/themes/responsiv-clean/assets/img/cubix-logo-dark.svg" alt="" />
            </div>
        </div>
        <div className="navright flex">
            <nav className='flex border border-green-900 min-w-24'>
