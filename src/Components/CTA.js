...
export default function CTA() {
  return (
    <>
      <section className="cta lg:items-center h-auto sm:h-auto  ml-4 lg:flex  xl:h-[50vh] sm:ml-8  text-black  md:h-auto   lg:h-[60vh] lg:flex-row lg:w-full text-lg flex flex-col justify-evenly items-start ">
        ...
        <div className="ctatop  lg:w-3/5 lg:h-auto  flex flex-col h-1/3 justify-around lg:flex-row lg:items-center ">
         ...
         <span className=" font-bold md:text-[28px] md:inline-block mb-4 w-auto lg:text-2xl">Got a Project&#63;</span>
          <a className="text-[#181b31] sm:opacity-85 md:text-2xl md:opacity-100 xl:text-xl"  href="http://#">
            Let's Talk
          </a>
          <a className="text-[#181b31] sm:opacity-85 md:text-lg xl:text-lg xl:pt-4 md:mt-2" href="http://#">
        ...
        <div className="flex flex-col justify-around h-auto md:h-1/2 xl:h-5/6 items-start ">
        ...
        <div className="flex flex-col justify-around h-auto md:h-1/2 xl:h-5/6">
